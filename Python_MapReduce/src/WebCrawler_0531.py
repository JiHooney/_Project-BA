...
#         driver.find_element_by_xpath('//*[@id="main-area"]/div[1]/div[1]/form/div[4]/button').click()
    ...
    soup = BeautifulSoup(search_url, 'html.parser')
          ...
          # 제목 추출
    subj_locate = '#main-area > div:nth-of-type(7) > table > tbody > tr:nth-of-type(1) > td.td_article > div.board-list > div > a.article'
...
#
#                    ##날짜
#         date_locate = '#main-area > div:nth-of-type(7) > table > tbody > tr:nth-of-type({}) > td.td_date'.format(n)
